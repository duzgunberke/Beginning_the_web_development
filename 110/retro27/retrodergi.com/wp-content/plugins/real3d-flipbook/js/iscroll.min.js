...
! function(n, r, d) {
    var m = n.requestAnimationFrame || n.webkitRequestAnimationFrame || n.mozRequestAnimationFrame || n.oRequestAnimationFrame || n.msRequestAnimationFrame || function(t) {
        ...
        f = function() {
            ...
            e.getTime = Date.now || function() {
                ...
                var r, h, a = t - i,
                    l = d.abs(a) / s;
                return h = l / (n = void 0 === n ? 6e-4 : n), (r = t + l * l / (2 * n) * (a < 0 ? -1 : 1)) < e ? (r = o ? e - o / 2.5 * (l / 8) : e, h = (a = d.abs(r - t)) / l) : 0 < r && (r = o ? o / 2.5 * (l / 8) : 0, h = (a = d.abs(t) + r) / l), {
                    destination: d.round(r),
                    duration: h
                }
            };
            var s = t("transform");
            return e.extend(e, {
                ...
                elastic: {
                    style: "",
                    fn: function(t) {
                        return 0 === t ? 0 : 1 == t ? 1 : .4 * d.pow(2, -10 * t) * d.sin((t - .055) * (2 * d.PI) / .22) + 1
                    }
                }
            }), e.tap = function(t, i) {
    ...
    function h(t, i, s) {
        ...
        return !0 === s && (e.style.cssText = "position:absolute;z-index:9999", o.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:absolute;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);border-radius:3px"), o.className = "iScrollIndicator", "h" == t ? (!0 === s && (e.style.cssText += ";height:7px;left:2px;right:2px;bottom:0", o.style.height = "100%"), e.className = "iScrollHorizontalScrollbar") : (!0 === s && (e.style.cssText += ";width:7px;bottom:2px;top:2px;right:1px", o.style.width = "100%"), e.className = "iScrollVerticalScrollbar"), e.style.cssText += ";overflow:hidden", i || (e.style.pointerEvents = "none"), e.appendChild(o), e
    }
    ...
    function a(t, i) {
        ...
        if (this.sizeRatioX = 1, this.sizeRatioY = 1, this.maxPosX = 0, this.maxPosY = 0, this.options.interactive && (this.options.disableTouch || (f.addEvent(this.indicator, "touchstart", this), f.addEvent(n, "touchend", this)), this.options.disablePointer || (f.addEvent(this.indicator, f.prefixPointerEvent("pointerdown"), this), f.addEvent(n, f.prefixPointerEvent("pointerup"), this)), this.options.disableMouse || (f.addEvent(this.indicator, "mousedown", this), f.addEvent(n, "mouseup", this))), this.options.fade) {
    ...
    t.prototype = {
        ...
        _move: function(t) {
            if (this.enabled && f.eventType[t.type] === this.initiated && ("pointermove" != t.type || t.isPrimary)) {
                ...
                var i, s, e, o, n = t.touches ? t.touches[0] : t,
                    ...
                    a = f.getTime();
                if (this.pointX = n.pageX, this.pointY = n.pageY, this.distX += r, this.distY += h, e = d.abs(this.distX), o = d.abs(this.distY), !(300 < a - this.endTime && e < 10 && o < 10)) {
        ...
        _end: function(t) {
            if (this.enabled && f.eventType[t.type] === this.initiated && ("pointerup" != t.type || t.isPrimary)) {
                ...
                var i, s, e = f.getTime() - this.startTime,
                    o = d.round(this.x),
                    n = d.round(this.y),
                ...
                if (this.isInTransition = 0, this.initiated = 0, this.endTime = f.getTime(), !this.resetPosition(this.options.bounceTime)) {
                    if (this.scrollTo(o, n), !this.moved) return this.options.tap && f.tap(t, this.options.tap), this.options.click && f.click(t), void this._execEvent("scrollCancel");
                    if (this._events.flick && e < 200 && r < 100 && h < 100) this._execEvent("flick");
                    else {
                        if (this.options.momentum && e < 300 && (i = this.hasHorizontalScroll ? f.momentum(this.x, this.startX, e, this.maxScrollX, this.options.bounce ? this.wrapperWidth : 0, this.options.deceleration) : {
                                destination: o,
                                duration: 0
                            }, s = this.hasVerticalScroll ? f.momentum(this.y, this.startY, e, this.maxScrollY, this.options.bounce ? this.wrapperHeight : 0, this.options.deceleration) : {
                                destination: n,
                                duration: 0
                            }, o = i.destination, n = s.destination, a = d.max(i.duration, s.duration), this.isInTransition = 1), this.options.snap) {
                            var c = this._nearestSnap(o, n);
                            this.currentPage = c, a = this.options.snapSpeed || d.max(d.max(d.min(d.abs(o - c.x), 1e3), d.min(d.abs(n - c.y), 1e3)), 300), o = c.x, n = c.y, this.directionX = 0, this.directionY = 0, l = this.options.bounceEasing
                        }
                        if (o != this.x || n != this.y) return (0 < o || o < this.maxScrollX || 0 < n || n < this.maxScrollY) && (l = f.ease.quadratic), this.scrollTo(o, n, a, l), void this._execEvent("scrollToPage");
        ...
        refresh: function() {
            f.getRect(this.wrapper), this.wrapperWidth = this.wrapper.clientWidth, this.wrapperHeight = this.wrapper.clientHeight;
            var t = f.getRect(this.scroller);
            this.scrollerW && (t.width = this.scrollerW), this.scrollerH && (t.height = this.scrollerH), this.scrollerWidth = d.round(t.width * this.scale), this.scrollerHeight = d.round(t.height * this.scale), this.maxScrollX = this.wrapperWidth - this.scrollerWidth, this.maxScrollY = this.wrapperHeight - this.scrollerHeight, this.hasHorizontalScroll = this.options.scrollX && this.maxScrollX < 0, this.hasVerticalScroll = this.options.scrollY && this.maxScrollY < 0, this.hasHorizontalScroll || (this.maxScrollX = 0, this.scrollerWidth = this.wrapperWidth), this.hasVerticalScroll || (this.maxScrollY = 0, this.scrollerHeight = this.wrapperHeight), this.endTime = 0, this.directionX = 0, this.directionY = 0, f.hasPointer && !this.options.disablePointer && (this.wrapper.style[f.style.touchAction] = f.getTouchAction(this.options.eventPassthrough, !0), this.wrapper.style[f.style.touchAction] || (this.wrapper.style[f.style.touchAction] = f.getTouchAction(this.options.eventPassthrough, !1))), this.wrapperOffset = f.offset(this.wrapper), this.wrapperOffsetLeft && (this.wrapperOffset.left = this.wrapperOffsetLeft), this.wrapperOffsetTop && (this.wrapperOffset.top = this.wrapperOffsetTop), this._execEvent("refresh"), this.resetPosition()
        },
        on: function(t, i) {
        ...
        scrollTo: function(t, i, s, e) {
            if (s) {
                ...
                if (this.nextDisabled && t == -(this.scrollerWidth - this.wrapperWidth)) return void this.goToPage(1, 0, 0)
            }
            this.options.keepInCenterH && this.getScrollerWidth() * this.scale < this.wrapperWidth && (t = this.wrapperWidth / 2 - this.getScrollerWidth() * this.scale / 2), this.options.keepInCenterV && this.getScrollerHeight() * this.scale < this.wrapperHeight && (i = this.wrapperHeight / 2 - this.getScrollerHeight() * this.scale / 2), e = e || f.ease.circular, this.isInTransition = this.options.useTransition && 0 < s;
        ...
        scrollToElement: function(t, i, s, e, o) {
            if (t = t.nodeType ? t : this.scroller.querySelector(t)) {
                ...
                !0 === s && (s = d.round(r.width / 2 - h.width / 2)), !0 === e && (e = d.round(r.height / 2 - h.height / 2)), n.left -= s || 0, n.top -= e || 0, n.left = 0 < n.left ? 0 : n.left < this.maxScrollX ? this.maxScrollX : n.left, n.top = 0 < n.top ? 0 : n.top < this.maxScrollY ? this.maxScrollY : n.top, i = null == i || "auto" === i ? d.max(d.abs(this.x - n.left), d.abs(this.y - n.top)) : i, this.scrollTo(n.left, n.top, i, o)
            }
        },
        ...
        _translate: function(t, i) {
            if (this.options.useTransform ? this.scrollerStyle[f.style.transform] = "translate(" + t + "px," + i + "px) scale(" + this.scale + ") " + this.translateZ : (t = d.round(t), i = d.round(i), this.scrollerStyle.left = t + "px", this.scrollerStyle.top = i + "px"), this.x = t, this.y = i, this.indicators)
        ...
        _zoomStart: function(t) {
            ...
            this.touchesDistanceStart = d.sqrt(i * i + s * s), this.startScale = this.scale, this.originX = d.abs(t.touches[0].pageX + t.touches[1].pageX) / 2 + this.wrapperOffset.left - this.x, this.originY = d.abs(t.touches[0].pageY + t.touches[1].pageY) / 2 + this.wrapperOffset.top - this.y, this._execEvent("zoomStart")
        },
        _zoom: function(t) {
            if (this.enabled && f.eventType[t.type] === this.initiated) {
                this.options.preventDefault && t.preventDefault();
                var i, s, e, o = d.abs(t.touches[0].pageX - t.touches[1].pageX),
                    n = d.abs(t.touches[0].pageY - t.touches[1].pageY),
                    r = d.sqrt(o * o + n * n),
                    h = 1 / this.touchesDistanceStart * r * this.startScale;
                this.scaled = !0, h < this.options.zoomMin ? h = .5 * this.options.zoomMin * d.pow(2, h / this.options.zoomMin) : h > this.options.zoomMax && (h = 2 * this.options.zoomMax * d.pow(.5, this.options.zoomMax / h)), i = h / this.startScale, s = this.originX - this.originX * i + this.startX, e = this.originY - this.originY * i + this.startY, this.scale = h, this.scrollTo(s, e, 0)
            }
        },
        _zoomEnd: function(t) {
            var i, s, e;
            this.enabled && f.eventType[t.type] === this.initiated && (this.options.preventDefault && t.preventDefault(), this.isInTransition = 0, this.initiated = 0, this.scale > this.options.zoomMax ? this.scale = this.options.zoomMax : this.scale < this.options.zoomMin && (this.scale = this.options.zoomMin), this.refresh(), e = this.scale / this.startScale, i = this.originX - this.originX * e + this.startX, s = this.originY - this.originY * e + this.startY, 0 < i ? i = 0 : i < this.maxScrollX && (i = this.maxScrollX), 0 < s ? s = 0 : s < this.maxScrollY && (s = this.maxScrollY), this.x == i && this.y == s || this.scrollTo(i, s, this.options.bounceTime), this.scaled = !1, this._execEvent("zoomEnd"))
        },
        zoom: function(t, i, s, e) {
            if (t < this.options.zoomMin ? t = this.options.zoomMin : t > this.options.zoomMax && (t = this.options.zoomMax), t != this.scale) {
                var o = t / this.scale,
                    n = this;
                1 != o && (clearTimeout(this.zoomStartTimeout), this.zoomStartTimeout = setTimeout(function() {
                    n._execEvent("zoomStart")
                }, 0), clearTimeout(this.wheelTimeout), this.wheelTimeout = setTimeout(function() {
                    n._execEvent("zoomEnd")
                }, Number(e + 100))), i = void 0 === i ? this.wrapperWidth / 2 : i, s = void 0 === s ? this.wrapperHeight / 2 : s, e = void 0 === e ? 300 : e, i = i + this.wrapperOffset.left - this.x, s = s + this.wrapperOffset.top - this.y, i = i - i * o + this.x, s = s - s * o + this.y, this.scale = t, this.refresh(), 0 < i ? i = 0 : i < this.maxScrollX && (i = this.maxScrollX), 0 < s ? s = 0 : s < this.maxScrollY && (s = this.maxScrollY), this.scrollTo(i, s, e)
            }
        },
        ...
        _wheel: function(t) {
            if (this.enabled) {
                ...
                e = this.x + d.round(this.hasHorizontalScroll ? i : 0), o = this.y + d.round(this.hasVerticalScroll ? s : 0), this.directionX = 0 < i ? -1 : i < 0 ? 1 : 0, this.directionY = 0 < s ? -1 : s < 0 ? 1 : 0, 0 < e ? e = 0 : e < this.maxScrollX && (e = this.maxScrollX), 0 < o ? o = 0 : o < this.maxScrollY && (o = this.maxScrollY), this.scrollTo(e, o, 0)
            }
        },
        _initSnap: function() {
            this.currentPage = {}, "string" == typeof this.options.snap && (this.options.snap = this.scroller.querySelectorAll(this.options.snap)), this.on("refresh", function() {
                var t, i, s, e, o, n, r, h = 0,
                    a = 0,
                    l = 0,
                ...
                if (this.pages = [], this.wrapperWidth && this.wrapperHeight && this.scrollerWidth && this.scrollerHeight) {
                    if (!0 === this.options.snap)
                        for (s = d.round(c / 2), e = d.round(p / 2); l > -this.scrollerWidth;) {
                            for (this.pages[h] = [], o = t = 0; o > -this.scrollerHeight;) this.pages[h][t] = {
                            ...
                            for (t = (n = this.options.snap).length, i = -1; h < t; h++) r = f.getRect(n[h]), (0 === h || r.left <= f.getRect(n[h - 1]).left) && (a = 0, i++), this.pages[a] || (this.pages[a] = []), l = d.max(-r.left, this.maxScrollX), o = d.max(-r.top, this.maxScrollY), s = l - d.round(r.width / 2), e = o - d.round(r.height / 2), this.pages[a][i] = {
                                x: l,
                                y: o,
                                width: r.width,
                                height: r.height,
        ...
        _nearestSnap: function(t, i) {
            ...
            var s = 0,
                e = this.pages.length,
                o = 0;
            if (d.abs(t - this.absStartX) < this.snapThresholdX && d.abs(i - this.absStartY) < this.snapThresholdY) return this.currentPage;
        ...
        goToPage: function(t, i, s, e) {
            ...
            var o = this.pages[t][i].x,
                n = this.pages[t][i].y;
            s = void 0 === s ? this.options.snapSpeed || d.max(d.max(d.min(d.abs(o - this.x), 1e3), d.min(d.abs(n - this.y), 1e3)), 300) : s, this.currentPage = {
                x: o,
                y: n,
                pageX: t,
                pageY: i
        ...
        _initKeys: function(t) {
            ...
            f.addEvent(n, "keydown", this), this.on("destroy", function() {
        ...
        _key: function(t) {
            if (this.enabled) {
                var i, s = this.options.snap,
                    ...
                    n = f.getTime(),
                    r = this.keyTime || 0;
                switch (this.options.useTransition && this.isInTransition && (i = this.getComputedPosition(), this._translate(d.round(i.x), d.round(i.y)), this.isInTransition = !1), this.keyAcceleration = n - r < 200 ? d.min(this.keyAcceleration + .25, 50) : 0, t.keyCode) {
        ...
        _end: function(t) {
            if (this.initiated) {
                if (this.initiated = !1, t.preventDefault(), t.stopPropagation(), f.removeEvent(n, "touchmove", this), f.removeEvent(n, f.prefixPointerEvent("pointermove"), this), f.removeEvent(n, "mousemove", this), this.scroller.options.snap) {
                    var i = this.scroller._nearestSnap(this.scroller.x, this.scroller.y),
                        s = this.options.snapSpeed || d.max(d.max(d.min(d.abs(this.scroller.x - i.x), 1e3), d.min(d.abs(this.scroller.y - i.y), 1e3)), 300);
        ...
        updatePosition: function() {
            ...
            this.options.ignoreBoundaries || (t < this.minBoundaryX ? ("scale" == this.options.shrink && (this.width = d.max(this.indicatorWidth + t, 8), this.indicatorStyle.width = this.width + "px"), t = this.minBoundaryX) : t > this.maxBoundaryX ? "scale" == this.options.shrink ? (this.width = d.max(this.indicatorWidth - (t - this.maxPosX), 8), this.indicatorStyle.width = this.width + "px", t = this.maxPosX + this.indicatorWidth - this.width) : t = this.maxBoundaryX : "scale" == this.options.shrink && this.width != this.indicatorWidth && (this.width = this.indicatorWidth, this.indicatorStyle.width = this.width + "px"), i < this.minBoundaryY ? ("scale" == this.options.shrink && (this.height = d.max(this.indicatorHeight + 3 * i, 8), this.indicatorStyle.height = this.height + "px"), i = this.minBoundaryY) : i > this.maxBoundaryY ? "scale" == this.options.shrink ? (this.height = d.max(this.indicatorHeight - 3 * (i - this.maxPosY), 8), this.indicatorStyle.height = this.height + "px", i = this.maxPosY + this.indicatorHeight - this.height) : i = this.maxBoundaryY : "scale" == this.options.shrink && this.height != this.indicatorHeight && (this.height = this.indicatorHeight, this.indicatorStyle.height = this.height + "px")), this.x = t, this.y = i, this.scroller.options.useTransform ? this.indicatorStyle[f.style.transform] = "translate(" + t + "px," + i + "px)" + this.scroller.translateZ : (this.indicatorStyle.left = t + "px", this.indicatorStyle.top = i + "px")
        },
        _pos: function(t, i) {
            t < 0 ? t = 0 : t > this.maxPosX && (t = this.maxPosX), i < 0 ? i = 0 : i > this.maxPosY && (i = this.maxPosY), t = this.options.listenX ? d.round(t / this.sizeRatioX) : this.scroller.x, i = this.options.listenY ? d.round(i / this.sizeRatioY) : this.scroller.y, this.scroller.scrollTo(t, i)
        },
        fade: function(t, i) {
            if (!i || this.visible) {
                ...
                var s = t ? 250 : 500,
                    e = t ? 0 : 300;
                t = t ? "1" : "0", this.wrapperStyle[f.style.transitionDuration] = s + "ms", this.fadeTimeout = setTimeout(function(t) {
                    this.wrapperStyle.opacity = t, this.visible = +t
                }.bind(this, t), e)
            }
        }
    }, t.utils = f, "undefined" != typeof module && module.exports ? module.exports = t : "function" == typeof define && define.amd ? define(function() {
        return t
    }) : n.IScroll = t, n.FLIPBOOK = n.FLIPBOOK || {}, n.FLIPBOOK.IScroll = t, n.PointerEvent = void 0
